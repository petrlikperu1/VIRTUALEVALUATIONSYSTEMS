...
// METODO DEL  MODULO DE  SEGURIDAD --------------------------------------------------------------------------
...
function validarAccesoPersonal(ruta)
{
   ...
   if (tipousu == '0')
    {   jAlert("Seleccione el Tipo Usuario por favor!!!");
    ...
    else
    {
        ...
        {  
            document.form.action=ruta+"/DocenteServlet";
...
function validarAccesoEstudiante(ruta)
{
...
// ----------------------------------------------------------------------------------------------------------------
// ----------------------------------------------------------------------------------------------------------------
// Inicio de Mantenimiento de la Tabla Semestre 07/08/2016 >----- Hecho por Ivan <--------
...
{   var codcarrera = document.getElementById('cbocarrera').value;
    ...
    var Usuario = document.getElementById('usuarioDoc').value;
    var Clave = document.getElementById('claveDoc').value;
   ...
   if (codcarrera == '0')
    ...
    else
    {
        if (ApellidoPaterno == '')
        {
            ...
            document.getElementById('txtapelpate').focus();
            return;
        }
        else
        {
            if (ApellidoMaterno == '')
            {
                ...
                document.getElementById('txtapelmate').focus();
                return;
            }
            else
            {
                ...
                {
                    jAlert("Ingresar el Usuario por favor!!!");
                    document.getElementById('usuarioDoc').focus();
                    return;
                } else {
                    if (Clave == '') {
                        jAlert("Ingresar la Clave por favor!!!");
                       document.getElementById('claveDoc').focus();
                        return;
                    } else {
...
{  var codcarrera = document.getElementById('cbocarrera').value;
    ...
    var ApellidoPaterno = document.getElementById('txtapelpate').value;
    var ApellidoMaterno = document.getElementById('txtapelmate').value;
    var Usuario = document.getElementById('usuarioAlu').value;
    var Clave = document.getElementById('passwordAlu').value;

    var parametros = '';
 if(codcarrera=='0')
 {
        jAlert("Elegir la  Carrera Profesional !!!!!!!");
        document.getElementById('cbocarrera').focus();
        return;  
 }else
 {
        ...
        else
        {
            ...
            else
            {
                if (Usuario == '')
                {
                    ...
                    document.getElementById('usuarioAlu').focus();
                    return;
                } else {
                    if (Clave == '') {
                        document.getElementById('passwordAlu').focus();
...
//TABLA ESTRUCTURA EXAMEN

// LA TABLA  SEMESTRE
function EliminarEstructuraExamen2(ruta,codigo) {
     var cbosemestre,cbocarrera,cbomateria,cbounidadtematica,cbotema,cbotipoexamen, txtTiempoMinutos, txtTotalPreguntas;
    ...
    var cbocontenido=document.getElementById('cbocontenido').value;    
...
var pagina = ruta + "/EstructuraExamenServlet?op=24";
    $.ajax({
        type: 'POST',
        url: pagina,
        //    dataType: 'JSON',
        data: {
         cbounidadtematica:cbounidadtematica,
                    cbotema:cbotema,
                    cbonivel:cbonivel,
                    txtcantpreg:txtcantpreg,
                    txtpuntajepreg:txtpuntajepreg,
                    txtpenalidadpreg:txtpenalidadpreg,
                    txtpenalidadayudas:txtpenalidadayudas
        },
        success: function (data) {
            document.getElementById("DivModal2").innerHTML = data;
...
var  totalpreg=0;
function agregarItemMarcoLogico(ruta)
{   var cbosemestre,cbocarrera,cbomateria,cbounidadtematica,cbotema,cbotipoexamen, txtTiempoMinutos, txtTotalPreguntas;
    cbosemestre = document.getElementById('cbosemestre').value;
    cbocarrera = document.getElementById('cbocarrera').value;
    cbomateria = document.getElementById('cbomateria').value;
...
if (cbounidadtematica == '0')
    ...
    {   jAlert('Elegir el Nivel de Dificultad !!!! ', 'Mensaje !!');
        document.getElementById('cbonivel').focus();        
        return;
    }else if (cbocontenido == '0')
    {   jAlert('Elegir el contenido de  capacidad  !!!! ', 'Mensaje !!');
        document.getElementById('cbocontenido').focus();        
        return;
    }    
    else if (txtcantpreg== '')
    {   jAlert('Ingresar la  Cantidad x  Preguntas', 'Mensaje !!');        
        document.getElementById('txtcantpreg').focus();
        return;
    }
    else if (txtpuntajepreg == '')
    {   jAlert('Ingresar el Puntaje de la  Pregunta', 'Mensaje !!');
        document.getElementById('txtpuntajepreg').focus();
    }
    else if (txtpenalidadpreg == '')
    {   jAlert('Ingresar penalidad por Pregunta Errada', 'Mensaje !!');      
        document.getElementById('txtpenalidadpreg').focus();
    }
    else if (txtpenalidadayudas == '')
    {   jAlert('Ingresar el Puntaje de la Ayuda', 'Mensaje !!');      
        document.getElementById('txtpenalidadayudas').focus();
    } else {
                var pagina = ruta + "/EstructuraExamenServlet?op=23";
                $.ajax({
                type: 'POST',
                url: pagina,      
                data: {
                ...
                success: function (data) {
                    document.getElementById("divMarco").innerHTML = data;
                    //cargaTablaJQUERY();
                }
            });
               document.getElementById('cbounidadtematica').value="0";
               document.getElementById('cbotema').value="0";
               document.getElementById('cbonivel').value="0"
               document.getElementById('txtcantpreg').value="";
               document.getElementById('txtpuntajepreg').value="";
               document.getElementById('txtpenalidadpreg').value="";
...
function AdicionarDetalleEntructuraExamen(ruta) {
    
//    EstructuraExamenBean.CODMATERIA = document.getElementById("cbonivel").value;
    
//    EstructuraExamenBean.CODUNIDTEMA = document.getElementById("txtcantpreg").value;
//    EstructuraExamenBean.CODTEMA = document.getElementById("txtpuntajepreg").value;
//    EstructuraExamenBean.CODMATERIA = document.getElementById("txtpenalidadpreg").value;
//    EstructuraExamenBean.CODMATERIA = document.getElementById("txtpenalidadayudas").value;
...
function   RendirExamen(ruta, tabla, op, parametros, tiempo, activartimer)
{   
    linML = 0;
    var pagina = ruta + "/" + tabla + "Servlet?op=" + op + parametros;
...
function   IniciarExamen(ruta, tabla, op)
{  
    linML = 0;
    var pagina = ruta + "/" + tabla + "Servlet?op=" + op;
    var tiempo = document.form.tiempo.value;
    var xmlhttp;
    if (window.XMLHttpRequest)
    {
        xmlhttp = new XMLHttpRequest();
...
function   siguientepregunta(ruta, tabla, op, limite)
{
    var clavealternativaelegida = document.form.rdop.value;
    var respuestaok = document.form.RESPUESTAOK.value;
    var errorpregunta = document.form.ERRORPREGUNTA.value;

    var CODDESARROLLOEXAMGENERADO = document.form.CODDESARROLLOEXAMGENERADO.value;

    var NUMEXAMDESARROLLOGENERADO = document.form.NUMEXAMDESARROLLOGENERADO.value;
...
function   FiltrarListaUsuariosEstudiantes(ruta,tabla,op,codcarrera)
{   
...
function   ListaUsuariosEstudiantes(ruta,tabla,op)
{     
    var  codcarrera=document.getElementById("cbocarrera").value;
    var  codalu=document.getElementById("cboalumno").value;
    var pagina=ruta+"/"+tabla+"Servlet?op="+op+"&codcarrera="+codcarrera+"&codalumno="+codalu;
    ...
    {   if(xmlhttp.readyState==4 && xmlhttp.status==200)
        {        var   estado=xmlhttp.responseText;
               ...
               {  document.getElementById("divtablalumnos").innerHTML=xmlhttp.responseText;
                   cargaTablaJQUERY();
               }                         
        }
    }                
...
{     
    ...
    function   RegistrarUsuarioAlumno(ruta,tabla,op)
{   var xmlhttp;  
    var  codcarrera=document.getElementById("cbocarrera").value;
    var  codalumno=document.getElementById("cboalumno").value;
    ...
    {
            jAlert("Seleccione al Estudiante !!!!", 'Validacion');
            document.getElementById("cboalumno").focus();
    ...
    {   if(xmlhttp.readyState==4 && xmlhttp.status==200)
        {       
                document.getElementById("divtabladocentes").innerHTML=xmlhttp.responseText;
                  cargaTablaJQUERY();
                  document.getElementById("divtablalumnos")   
...
{   var xmlhttp;  
    ...
    {   if(xmlhttp.readyState==4 && xmlhttp.status==200)
        {       
                document.getElementById("divtabladocentes").innerHTML=xmlhttp.responseText;
                  cargaTablaJQUERY();
                  document.getElementById("divtabladocentes")   
...
// SUBIR  IMAGENES -------------------------------------------------------------------------------------------------------
             ...
             function  SubirImagen(ruta,tabla,op,parametros)
              {   
               ...
               function  SubirImagenPreguntaExamenSupervisado(ruta)
              {   var url=ruta+"/BancoPreguntas/Pregunta/ExamenSupervisado/SubirImagenPreguntaExamenSupervisado.jsp";                  
                    var posicion_x; 
                    var posicion_y; 
                    var ancho=400;
                    var alto=100;
              ...
              function  SubirImagenPreguntaExamenTrainig(ruta)
              {   var url=ruta+"/BancoPreguntas/Pregunta/ExamenTrainig/SubirImagenPreguntaExamenTraining.jsp";                  
                    var posicion_x; 
                    var posicion_y; 
                    var ancho=400;
                    var alto=100;
